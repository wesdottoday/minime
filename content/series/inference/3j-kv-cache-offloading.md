...
siblings:
  ...
  - "3i"
  - "3k"
url: "/series/inference/what-happens/prefill-decode/kv-cache/kv-cache-offloading/"
aliases:
  - "/llms/what-happens/prefill-decode/kv-cache/kv-cache-offloading/"
...
- **Sliding window + landmarks**: keep a local window in HBM, plus the first few tokens and any tokens flagged as high-attention during [prefill](/series/inference/what-happens/prefill-decode/). Evict everything else. This maps well to observed attention patterns.
