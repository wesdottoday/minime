...
siblings:
  ...
  - "3i"
  - "3j"
url: "/series/inference/what-happens/prefill-decode/kv-cache/mqa-gqa/"
aliases:
  - "/llms/what-happens/prefill-decode/kv-cache/mqa-gqa/"
...
GQA with 8 KV heads gives an **8× reduction** in [KV cache](/series/inference/what-happens/prefill-decode/kv-cache/) size with negligible quality loss — research shows it matches MHA quality closely while being dramatically more memory-efficient. This is why nearly all modern large models (Llama 3, Mistral, Gemma) use GQA.
