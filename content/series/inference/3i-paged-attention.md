...
siblings:
  ...
  - "3j"
  - "3k"
url: "/series/inference/what-happens/prefill-decode/kv-cache/paged-attention/"
aliases:
  - "/llms/what-happens/prefill-decode/kv-cache/paged-attention/"
...
graph LR
    ...
    click A "/series/inference/what-happens/prefill-decode/kv-cache/"
    click B "/series/inference/what-happens/prefill-decode/kv-cache/"
    click C "/series/inference/what-happens/prefill-decode/kv-cache/"
```

The problem paged attention solves isn't the size of the [KV cache](/series/inference/what-happens/prefill-decode/kv-cache/) per se — it's **fragmentation** and **waste** when serving many concurrent requests.
