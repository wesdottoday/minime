...
siblings:
  ...
  - "2e"
  - "2g"
url: "/series/inference/what-happens/embeddings/layer-transforms/"
aliases:
  - "/llms/what-happens/embeddings/layer-transforms/"
...
graph LR
    ...
    click K "/series/inference/what-happens/embeddings/model-layers/ffn-deep-dive/"
    click L "/series/inference/what-happens/embeddings/model-layers/"
    click N "/series/inference/what-happens/embeddings/model-layers/final-vector-to-token/"
    click O "/series/inference/what-happens/embeddings/model-layers/final-vector-to-token/"
```
...
The **nonlinear function** (called an activation function) is crucial, and it's easier to understand why if you think about the layer progression from [model layers](/series/inference/what-happens/embeddings/model-layers/)):
