...
children: []
siblings: []
url: "/series/inference/what-happens/vectors/dot-product/"
aliases:
  - "/llms/what-happens/vectors/dot-product/"
...
- **The final prediction layer** uses a dot product between the last [hidden state](/series/inference/what-happens/embeddings/hidden-states/) and each vocabulary token's vector to score how likely each token is to come next
