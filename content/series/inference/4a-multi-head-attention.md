...
children: []
siblings: []
url: "/series/inference/what-happens/embeddings/model-layers/attention-deep-dive/multi-head-attention/"
aliases:
  - "/llms/what-happens/embeddings/model-layers/attention-deep-dive/multi-head-attention/"
...
graph TD
    ...
    click S "/series/inference/what-happens/tokens/tokenization/"
    click H1 "/series/inference/what-happens/embeddings/model-layers/attention-deep-dive/"
    click H2 "/series/inference/what-happens/embeddings/model-layers/attention-deep-dive/"
    click H64 "/series/inference/what-happens/embeddings/model-layers/attention-deep-dive/"
...
This is where **[Grouped-Query Attention](/series/inference/what-happens/prefill-decode/kv-cache/mqa-gqa/) (GQA)** comes in — a compromise between full multi-head and the extreme of Multi-Query Attention (MQA, which uses just 1 shared K/V head). GQA groups the 64 query heads into, say, 8 groups, sharing one set of K/V across each group. This cuts the [KV cache](/series/inference/what-happens/prefill-decode/kv-cache/) by 8× while retaining most of multi-head's expressiveness:
