...
children: []
siblings: []
url: "/series/inference/what-happens/thinking/planning/"
aliases:
  - "/llms/what-happens/thinking/planning/"
...
Planning is an extension of thinking ([thinking](/series/inference/what-happens/thinking/)) combined with tool use ([tool calls](/series/inference/what-happens/tool-calls/)). The model doesn't have a planner module — it generates a plan as text, then executes it step by step through the normal token generation and tool call loop.
...
- **Context is the working memory.** Every tool result, every intermediate thought, every step of the plan lives in the context as tokens. The model can reference any of it through attention. But it all competes for space in the context window and [KV cache](/series/inference/what-happens/prefill-decode/kv-cache/).
