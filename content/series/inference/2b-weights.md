...
siblings:
  ...
  - "2f"
  - "2g"
url: "/series/inference/what-happens/embeddings/weights/"
aliases:
  - "/llms/what-happens/embeddings/weights/"
...
graph LR
    ...
    click I "/series/inference/what-happens/embeddings/layer-transforms/"
    click J "/series/inference/what-happens/embeddings/model-layers/ffn-deep-dive/"
...
Weights live in matrices (grids of numbers). The [embedding table](/series/inference/what-happens/embeddings/) you just learned about is one matrix of weights — 128,000 rows × 8,192 columns = ~1 billion weights, just for embeddings. But that's a tiny fraction. The vast majority of weights live in the model's layers (more on those in [model layers](/series/inference/what-happens/embeddings/model-layers/)), where they define the transformations that happen to your token vectors as they flow through the network.
